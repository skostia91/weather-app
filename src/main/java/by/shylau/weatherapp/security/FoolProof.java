...
public class FoolProof {
    public static String defenceForFool(String password) {
        return switch (password) {
            case "password" -> "Пароль слишком простой, выбери что-то посложнее.";
            case "111" -> "Серьёзно? 111? У нас серьёзная организация. Выбери другой пароль.";
            case "1111" ->
                    "Такой пароль легко взломать и бандит может узнать в каких городах ты смотришь погоду. Поменяй";
            case "11111" ->
            ...
            case "888" -> "888? Я понял - это вызов кто первым сломается после попыток ввести слабый пароль. " +
                    "Интересно, кто же победит: само Совершенство или кожаный мешок";
            case "999" -> "999? Ладно, твоя взяла, незнакомец, ты победил, но установи нормальный пароль";
            case "000" -> "Я понял, мы наверное начали с 111 и дошли до 000 и ты хочешь увидеть секретную концовку. " +
                    "Хорошо, вам будет представлен отрывок из классического произведения Кровь и бетон: У****ок, " +
                    ...
                    + " у*****к, ******* чёртов, будь ты проклят! Иди, идиот, ******* тебя и всю твою семью! " +
                    "***** собачье, жлоб (плохо пахнущий), ******, (собака женского рода), (нехороший человек)! " +
                    "Иди сюда, мерзавец, негодяй, гад! Иди сюда, ты, *****, (попа)!...... Но пароль надо поменять";
            case "0000" -> "Всё, я звоню твоим родителям, чтобы они всыпали тебе ремня.";
            ...
            case "aaa" ->
                    "Я думал, что у меня хорошая память, но ваш пароль такой простой, что я его уже забыл. Поменяй";
