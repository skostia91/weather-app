...
public class FoolProof {
    ...
    public static String defenceForFool(String password) {
        return switch (password) {
            ...
            case "444" -> "Оригинально. Можно до вечера писать 555, 666 .... Установи нормальный пароль который не взломают за 2 минуты.";
            case "555" -> "Я никуда не спешу. Установи нормальный пароль который не взломают за 2 минуты.";
            case "666" -> "666? Я сейчас материться начну после таких паролей. Установи нормальный пароль который не взломают за 2 минуты.";
            case "777" ->
                    "Что за детский сад, просто установи нормальный пароль, а то я сейчас вылезу из компуктера и дам ремня за такой слабый пароль";
            ...
            case "999" -> "999? Ладно, твоя взяла, незнакомец, ты победил и я понимаю что ты будешь издеваться такими паролями," +
                    " но чтобы зайти в систему надо установить нормальный пароль, который не взломают за 2 минуты.";
            case "000" -> "Я понял, мы наверное начали с 111 и дошли до 000 и ты столько раз ввёл слабый пароль который не взломают за 2 минуты " +
